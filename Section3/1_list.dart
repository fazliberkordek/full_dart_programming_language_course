void main() {
  ...
  print(
      "customer1'smoney is ${bank[0]}"); //! customer1'smoney is 100 an idexed at 0

  //^ You can use some methods on the list:

  print(
      "Lenght of the bank List is = ${bank.length}"); //! customer1'smoney is 3
  ...
  for (int i = 0; i < CustomerMoney2.length; i++) {
    ...
    if (CustomerMoney2[i] > 35) {
      ...
      print(
          'Deny acces for credit card but we will give you a loan and icnrease your credit point by 10');
    } else {
